...
{
	void command_list_month(const string&,const string&,entry_kind,const string&,const string&,bool);
	void command_list_year(const string&,entry_kind,const string&,const string&);
	void command_list_all_years(entry_kind,const string&,const string&);
