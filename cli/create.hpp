...
namespace scilog_cli
{
	...
	void command_create_sql_dump_month(const string&,const string&,const string&);
	void command_create_sql_dump_year(const string&,const string&);
	void command_create_sql_dump_all_years(const string&);
}
