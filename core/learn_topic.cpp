...
namespace scilog_cli
{
	...
	learn_topic::learn_topic(const string& new_type,const string& new_category,const string& new_name,const string& new_start_date,const string& new_end_date,const string& new_description,const string& new_parent_topic,bool new_finished,int new_pages) : topic(new_category,new_name,new_start_date,new_end_date,new_description,new_parent_topic,new_finished),type(new_type),pages(new_pages)
	{
	}
