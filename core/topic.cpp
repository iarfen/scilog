...
{
	topic::topic() : category(),name(),start_date(),end_date(),description(),parent_topic(),finished()
	{
	}

	topic::topic(const string& new_category,const string& new_name,const string& new_start_date,const string& new_end_date,const string& new_description,const string& new_parent_topic,bool new_finished) : category(new_category),name(new_name),start_date(new_start_date),end_date(new_end_date),description(new_description),parent_topic(new_parent_topic),finished(new_finished)
	{
	}
