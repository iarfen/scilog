...
{
	topic::topic() : category(),name(),start_date(),end_date(),description()
	{
	}

	topic::topic(const string& new_category,const string& new_name,const string& new_start_date,const string& new_end_date,const string& new_description) : category(new_category),name(new_name),start_date(new_start_date),end_date(new_end_date),description(new_description)
	{
	}
